...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>RedDoorz Hotel,</p>
				<p>49, 85 M. L. Quezon Street,<br>Taguig City,<br>Philippines.</p>
				<p>(+63) 995 136 5076 </p>
			</address>
			<span><img alt="" src="assets/img/rd.jpg"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- boq.qfinspection@gmail.com || Web :- https://www.reddoorz.com/en-ph || Phone :- +(02) 8249 8745 </p>
			</div>
		</aside>
	</body>
</html>
